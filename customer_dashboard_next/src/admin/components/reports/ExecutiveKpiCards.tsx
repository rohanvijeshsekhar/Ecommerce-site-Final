  ...
  const cards = [
    {
      ...
      subtitle: data.financials ? `Gross: ${data.financials.gross_sales_formatted} | Refunds: ${data.financials.refunds_formatted}` : 'Net platform revenue',
    },
    {
      title: 'Valid Orders',
      ...
      subtitle: data.orders.subtitle || `${data.orders.value} valid orders (${data.orders.other_attempts || 0} other attempts)`,
    },
    {
