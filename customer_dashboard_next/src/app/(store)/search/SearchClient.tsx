                    ...
                    <div className="grid grid-cols-2 gap-1.5 pt-0.5">
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setInputMinPrice(e.target.value)}
                          onBlur={() => updateUrl({ min_price: inputMinPrice || null })}
                          className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-4 pr-1 py-1.5 text-[11px] font-bold text-slate-800 focus:outline-none focus:border-[#006670] focus:bg-white transition-colors"
                        />
                      </div>
                      <div className="relative">
                        <span className="absolute left-2 top-1.5 text-[10px] font-bold text-slate-400">₹</span>
                      ...
                      >
                        <span
                          className={`pointer-events-none inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow-xs ring-0 transition duration-200 ease-in-out ${
                            inStockOnly ? 'translate-x-3.5' : 'translate-x-0'
                          }`}
                        />
                      </button>
                    </label>
