...
export default function SearchClient({
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen pt-[88px] sm:pt-[108px] lg:pt-[180px] pb-24 font-sans text-slate-800 antialiased selection:bg-[#006670]/20 selection:text-[#006670]">
