...
const DealerPortalPage: React.FC<DealerPortalPageProps> = ({
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-4 pt-[108px] lg:pt-[144px] pb-10 flex flex-col gap-6 animate-pulse">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-[108px] lg:pt-[144px] pb-20 flex flex-col gap-6">
