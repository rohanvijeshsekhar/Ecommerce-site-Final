              ...
              <div className="relative w-full aspect-[3/3.7] sm:aspect-[16/9] md:aspect-[3/1] flex items-center">
                ...
                <div className="absolute inset-0 w-full h-full z-0 select-none">
                  {slide.mobile_image_url ? (
                    <>
                      {/* Mobile view image (exact 3:3.7 ratio from admin panel) */}
                      <Image
                        ...
                        priority={idx === 0}
                        sizes="100vw"
                        className="object-cover object-center z-0 select-none md:hidden"
                      />
                      {/* Desktop view image */}
                      <Image
                        ...
                        priority={idx === 0}
                        sizes="100vw"
                        className="object-cover md:object-center z-0 select-none hidden md:block"
                      />
                    </>
                  ) : (
                    <Image
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-14 lg:px-20 flex justify-start items-center h-full pointer-events-none">
                  <div className="text-left select-none pointer-events-auto max-w-[320px] sm:max-w-[440px] md:max-w-[540px] lg:max-w-[640px] py-4">
                    ...
                    {slide.subheading && (
                      <p className="text-[13px] sm:text-[14px] md:text-sm text-slate-600 font-medium mb-3 md:mb-4 line-clamp-2 max-w-xs md:max-w-md">
                        {slide.subheading}
                      </p>
                    )}
