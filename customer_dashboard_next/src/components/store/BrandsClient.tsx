...
export default function BrandsClient() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-24 pt-[108px] lg:pt-[180px]">
      ...
      <div id="brands-grid" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div className="mb-5">
          <div className="flex items-center w-full max-w-sm h-[36px] sm:h-[38px] px-3 rounded-full border border-[#006670]/25 bg-white hover:border-[#006670]/50 focus-within:border-[#006670]/70 hover:shadow-[0_1px_6px_rgba(0,102,112,0.06)] focus-within:shadow-[0_2px_10px_rgba(0,102,112,0.1)] transition-all duration-200 gap-2 relative">
            <Search className="w-3.5 h-3.5 text-[#006670] shrink-0" />
            <input
              type="text"
              value={searchQuery}
              onChange={e => setSearchQuery(e.target.value)}
              placeholder="Search brands (e.g. 3M, NSK)..."
              className="flex-grow min-w-0 h-full bg-transparent border-none outline-none focus:outline-none focus:ring-0 text-xs sm:text-[13px] font-medium text-slate-800 placeholder-slate-400"
            />
            {searchQuery && (
              <button
