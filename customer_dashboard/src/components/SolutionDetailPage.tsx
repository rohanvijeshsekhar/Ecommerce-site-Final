...
import { ArrowLeft, Sparkles, Package, Star, ShoppingCart, Filter, Search, CheckCircle, ShieldCheck } from 'lucide-react';
...
const SolutionDetailPage: React.FC<SolutionDetailPageProps> = ({ slug, onBack, onAddToCart }) => {
  ...
  useEffect(() => {
    ...
    api.get(`solutions/${slug}/`)
      ...
      .catch(() => {
        // Fallback default mockup solution if API fails
        setSolution({
          id: 1,
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-24 text-left select-none">
      {/* Banner & Header */}
                  ...
                  <div className="p-4 flex flex-col justify-between flex-1">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                        ...
                        <button
                          onClick={() => onAddToCart && onAddToCart({ ...p, name, price, image })}
