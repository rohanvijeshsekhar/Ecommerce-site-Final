              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-slate-100">
                  ...
                  <button
                    onClick={() => {
                      if (onSelectSolution) {
                        onSelectSolution('restorative-dentistry');
                      } else {
              ...
              >
                <div>
                  ...
                  <div className="w-full h-52 bg-slate-50 rounded-2xl flex items-center justify-center p-4 relative overflow-hidden mb-5">
                    ...
                    {/* Premium Badge */}
                    <span className="absolute top-3 left-3 bg-[#006670] text-white text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                      {offer.badge}
                    </span>

                    <span className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-md text-slate-600 text-[10px] font-bold px-2.5 py-1 rounded-full border border-slate-200">
                      {offer.brand}
                    </span>
                  </div>
