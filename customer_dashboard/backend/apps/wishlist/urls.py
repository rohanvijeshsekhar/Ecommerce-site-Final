...
urlpatterns = [
    ...
    path("items/<str:product_id>/", WishlistItemDetailView.as_view(), name="wishlist-item-detail"),
    path("items/<str:product_id>/move-to-cart/", WishlistMoveToCartView.as_view(), name="wishlist-move-to-cart"),
