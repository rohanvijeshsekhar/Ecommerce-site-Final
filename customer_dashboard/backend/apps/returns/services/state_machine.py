...
class ReturnStateMachineService:
    ...
    ALLOWED_TRANSITIONS: Dict[ReturnStatus, List[ReturnStatus]] = {
        ...
        ReturnStatus.RETURN_DELIVERED: [
            ReturnStatus.VERIFICATION_PENDING,
            ReturnStatus.QC_PENDING,
            ReturnStatus.ITEM_RECEIVED,
            ReturnStatus.VERIFICATION_PASSED,
        ...
        ReturnStatus.REPLACEMENT_PENDING: [
            ...
            ReturnStatus.NEW_SHIPMENT_CREATED,
            ReturnStatus.REPLACEMENT_SHIPPED,
        ],
        ReturnStatus.REPLACEMENT_APPROVED: [
            ReturnStatus.REPLACEMENT_PROCESSING,
            ReturnStatus.NEW_SHIPMENT_CREATED,
            ReturnStatus.NEW_SHIPMENT_IN_TRANSIT,
            ReturnStatus.REPLACEMENT_SHIPPED,
        ],
        ReturnStatus.REPLACEMENT_PROCESSING: [
            ReturnStatus.NEW_SHIPMENT_CREATED,
    ...
    STATUS_NOTIFICATION_MAP = {
        ...
        ReturnStatus.REVERSE_SHIPMENT_CREATED: NotificationType.ORDER_PACKED,
        ReturnStatus.PICKUP_SCHEDULED: NotificationType.ORDER_SHIPPED,
        ReturnStatus.PICKED_UP: NotificationType.ORDER_SHIPPED,
        ReturnStatus.RETURN_IN_TRANSIT: NotificationType.ORDER_SHIPPED,
        ReturnStatus.RETURN_DELIVERED: NotificationType.ORDER_PACKED,
        ReturnStatus.ITEM_RECEIVED: NotificationType.ORDER_PACKED,
        ReturnStatus.QC_PASSED: NotificationType.ORDER_PACKED,
        ReturnStatus.VERIFICATION_PASSED: NotificationType.ORDER_PACKED,
        ReturnStatus.QC_FAILED: NotificationType.ORDER_CANCELLED,
        ReturnStatus.VERIFICATION_FAILED: NotificationType.ORDER_CANCELLED,
        ReturnStatus.REFUND_PENDING: NotificationType.ORDER_PACKED,
        ReturnStatus.REFUNDED: NotificationType.REFUND_COMPLETED,
        ReturnStatus.REPLACEMENT_APPROVED: NotificationType.ORDER_PACKED,
        ReturnStatus.NEW_SHIPMENT_CREATED: NotificationType.ORDER_PACKED,
        ReturnStatus.NEW_SHIPMENT_IN_TRANSIT: NotificationType.ORDER_SHIPPED,
        ReturnStatus.REPLACEMENT_SHIPPED: NotificationType.ORDER_SHIPPED,
        ReturnStatus.DELIVERED: NotificationType.ORDER_DELIVERED,
