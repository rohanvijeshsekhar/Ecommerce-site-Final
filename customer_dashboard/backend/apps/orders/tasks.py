    ...
    try:
        ...
        notification = NotificationService.create(
            ...
            context={
                ...
                "cod_fee": str(getattr(order, "cod_fee", "0.00")),
                "cod_collectable_amount": str(getattr(order, "cod_collectable_amount", order.total_amount)),
                "payment_method": "Cash on Delivery" if str(order.payment_method or "").strip().lower() in ("cod", "cash_on_delivery") else (order.payment_method or "Online (Razorpay)").upper(),
